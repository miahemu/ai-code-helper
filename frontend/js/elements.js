export const elements = {
    ...
    conversationDeleteDialog: document.getElementById('conversationDeleteDialog'),
    conversationDeleteBackdrop: document.getElementById('conversationDeleteBackdrop'),
    conversationDeleteCancel: document.getElementById('conversationDeleteCancel'),
    conversationDeleteClose: document.getElementById('conversationDeleteClose'),
    conversationDeleteConfirm: document.getElementById('conversationDeleteConfirm'),
    conversationDeleteDescription: document.getElementById('conversationDeleteDescription'),
    ...
    newConversationButton: document.getElementById('newConversationBtn'),
    ...
    selectedKnowledgeDocuments: document.getElementById('selectedKnowledgeDocuments'),
